...
describe("Events", () => {
    ...
    it("Special special tags", () =>
        runTest(
            "<title>BIGBANG OT5</title><sitle><b></b></sitle><ttyle><b></b></ttyle><sCriPT></scripter</soo</sCript><STyLE></styler</STylE><sCiPt><stylee><scriptee><soo>",
        ));
    ...
    it("Start & end indices from domhandler", () =>
        runTest(
            "<!DOCTYPE html> <html> <title>BIGBANG OT5</title> <body class='foo'>Hello world <p></p></body> <!-- the comment --> </html> ",
        ));
